...
class SoftBorderColorPicker : public ColorPicker
{
  public:
    ...
    /**
    * Returns if the given xCurr and yCurr points are within distance of
    * xPoint and yPoint and within the image
    */
    bool isWithinDistance(unsigned int xCurr, unsigned int yCurr, unsigned int xPoint, unsigned int yPoint);
    bool isWithinImage(unsigned int x, unsigned int y);
